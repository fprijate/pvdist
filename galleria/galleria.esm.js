...
function render$3(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", mergeProps({ class: "p-galleria-item-wrapper" }, _ctx.ptm('itemWrapper')), [
    createElementVNode("div", mergeProps({ class: "p-galleria-item-container" }, _ctx.ptm('itemContainer')), [
      ($props.showItemNavigators)
        ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
            ...
            (openBlock(), createBlock(resolveDynamicComponent($props.templates.previousitemicon || 'ChevronLeftIcon'), mergeProps({ class: "p-galleria-item-prev-icon" }, _ctx.ptm('previousItemIcon')), null, 16))
          ], 16, _hoisted_1$3)), [
            [_directive_ripple]
          ])
      ...
      ($props.showItemNavigators)
        ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
            ...
            (openBlock(), createBlock(resolveDynamicComponent($props.templates.nextitemicon || 'ChevronRightIcon'), mergeProps({ class: "p-galleria-item-next-icon" }, _ctx.ptm('nextItemIcon')), null, 16))
          ], 16, _hoisted_3$2)), [
            [_directive_ripple]
          ])
        : createCommentVNode("", true),
...
function render$2(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return (openBlock(), createElementBlock("div", mergeProps({ class: "p-galleria-thumbnail-wrapper" }, _ctx.ptm('thumbnailWrapper')), [
    createElementVNode("div", mergeProps({ class: "p-galleria-thumbnail-container" }, _ctx.ptm('thumbnailContainer')), [
      ($props.showThumbnailNavigators)
        ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
            ...
            (openBlock(), createBlock(resolveDynamicComponent($props.templates.previousthumbnailicon || ($props.isVertical ? 'ChevronUpIcon' : 'ChevronLeftIcon')), mergeProps({ class: "p-galleria-thumbnail-prev-icon" }, _ctx.ptm('previousThumbnailIcon')), null, 16))
          ], 16, _hoisted_1$2)), [
            [_directive_ripple]
          ])
        : createCommentVNode("", true),
      ...
      ($props.showThumbnailNavigators)
        ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
            ...
            (openBlock(), createBlock(resolveDynamicComponent($props.templates.nextthumbnailicon || ($props.isVertical ? 'ChevronDownIcon' : 'ChevronRightIcon')), mergeProps({ class: "p-galleria-thumbnail-next-icon" }, _ctx.ptm('nextThumbnailIcon')), null, 16))
          ], 16, _hoisted_4)), [
            [_directive_ripple]
          ])
        : createCommentVNode("", true)
    ...
    ? (openBlock(), createElementBlock("div", mergeProps({
        ...
        (_ctx.$attrs.fullScreen)
          ? withDirectives((openBlock(), createElementBlock("button", mergeProps({
              ...
              (openBlock(), createBlock(resolveDynamicComponent(_ctx.$attrs.templates['closeicon'] || 'TimesIcon'), mergeProps({ class: "p-galleria-close-icon" }, _ctx.ptm('closeIcon')), null, 16))
            ], 16, _hoisted_2)), [
              [_directive_ripple]
            ])
          : createCommentVNode("", true),
