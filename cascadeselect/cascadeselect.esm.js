      ...
      return (openBlock(), createElementBlock("li", mergeProps({
        ...
        withDirectives((openBlock(), createElementBlock("div", mergeProps({
          ...
          ($options.isOptionGroup(processedOption))
            ? (openBlock(), createBlock(resolveDynamicComponent($props.templates['optiongroupicon'] ? $props.templates['optiongroupicon'] : $props.optionGroupIcon ? 'span' : 'AngleRightIcon'), {
                key: 2,
